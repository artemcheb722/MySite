...
from services.rabbit.constans import SupportedQueues
...
async def creat_user(new_user: RegisterUserFields, session: AsyncSession = Depends(get_async_session)) -> BaseUserInfo:
